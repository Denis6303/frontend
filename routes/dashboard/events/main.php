...
Route::prefix('brouillon/creer')->name('draft.create.')->group(function () {
    Route::get('/etape-1', [EventDraftController::class, 'showStep1'])->name('step1');
    Route::get('/etape-2', [EventDraftController::class, 'showStep2'])->name('step2');
    Route::get('/etape-3', [EventDraftController::class, 'showStep3'])->name('step3');
