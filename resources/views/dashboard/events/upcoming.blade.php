<div class="tab-pane fade show active" id="upcoming-tab" role="tabpanel">
    @forelse($eventsByStatus['upcoming'] ?? [] as $event)
        @php
            $cover = $event['cover_url'] ?? asset('images/event-imgs/img-7.jpg');
            ...
            <div class="contact-list">
                ...
                <div class="bottom d-flex flex-wrap justify-content-between align-items-center p-4">
                    <div class="icon-box">
                        ...
                        <p>Status</p>
                        <h6 class="coupon-status">{{ ucfirst($event['status'] ?? 'upcoming') }}</h6>
                    </div>
                    <div class="icon-box">
                        <span class="icon">
