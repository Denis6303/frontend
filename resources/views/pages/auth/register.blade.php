...
@section('content')
    <div class="registration">
        ...
        <div class="social-btns-list mb-lg-5">
            <a href="{{ route('auth.social.redirect', ['locale' => $locale ?? app()->getLocale(), 'provider' => 'google']) }}" class="social-login-btn text-decoration-none">
            ...
            <a href="{{ route('auth.social.redirect', ['locale' => $locale ?? app()->getLocale(), 'provider' => 'tiktok']) }}" class="social-login-btn text-decoration-none mt-3">
                <i class="fab fa-tiktok me-2"></i>{{ __('Continue with TikTok') }}
            </a>
        </div>
